...
it('should match by a glob pattern through a request', function (): void {
    ...
    Route::get('/', fn (): mixed => DataBag::resolveByGlob('meta'));
    Route::get('/posts', fn (): mixed => DataBag::resolveByGlob('meta'));
    Route::get('/posts/hello-world', fn (): mixed => DataBag::resolveByGlob('meta'));
